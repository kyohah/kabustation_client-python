...
class RankingDefaultResponseRankingInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["false", "Trend", "AverageRanking", "Symbol", "SymbolName", "CurrentPrice", "ChangeRatio", "ChangePercentage", "CurrentPriceTime", "TradingVolume", "Turnover", "ExchangeName", "CategoryName"]
