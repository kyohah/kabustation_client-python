...
class RankingByTradeValueResponseRankingInner(BaseModel):
    """
    ...
    rapid_payment_percentage: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="代金急増（％）", alias="RapidPaymentPercentage")
    ...
    __properties: ClassVar[List[str]] = ["false", "Trend", "AverageRanking", "Symbol", "SymbolName", "CurrentPrice", "ChangeRatio", "RapidPaymentPercentage", "Turnover", "CurrentPriceTime", "ChangePercentage", "ExchangeName", "CategoryName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "RapidPaymentPercentage": obj.get("RapidPaymentPercentage"),
