...
class RequestUnregister(BaseModel):
    """
    RequestUnregister
    """ # noqa: E501
    symbols: Optional[List[RequestRegisterSymbolsInner]] = Field(default=None, description="※為替銘柄を登録する場合、銘柄名は\"通貨A\" + \"/\" + \"通貨B\"、市場コードは\"300\"で指定してください。 例：'Symbol': 'EUR/USD', \"Exchange\": 300", alias="Symbols")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Symbols": [RequestRegisterSymbolsInner.from_dict(_item) for _item in obj["Symbols"]] if obj.get("Symbols") is not None else None
        })
        return _obj
