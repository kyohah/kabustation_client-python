...
class RankingByTradeVolumeResponseRankingInner(BaseModel):
    """
    ...
    rapid_trade_percentage: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="売買高急増（％）", alias="RapidTradePercentage")
    ...
    __properties: ClassVar[List[str]] = ["false", "Trend", "AverageRanking", "Symbol", "SymbolName", "CurrentPrice", "ChangeRatio", "RapidTradePercentage", "TradingVolume", "CurrentPriceTime", "ChangePercentage", "ExchangeName", "CategoryName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "RapidTradePercentage": obj.get("RapidTradePercentage"),
