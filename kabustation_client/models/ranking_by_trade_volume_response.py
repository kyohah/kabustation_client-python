...
class RankingByTradeVolumeResponse(BaseModel):
    """
    ...
    ranking: Optional[List[RankingByTradeVolumeResponseRankingInner]] = Field(default=None, description="ランキング", alias="Ranking")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Ranking": [RankingByTradeVolumeResponseRankingInner.from_dict(_item) for _item in obj["Ranking"]] if obj.get("Ranking") is not None else None
        })
        return _obj
