...
class RequestCancelOrder(BaseModel):
    """
    RequestCancelOrder
    """ # noqa: E501
    order_id: StrictStr = Field(description="注文番号<br>sendorderのレスポンスで受け取るOrderID。", alias="OrderId")
    password: StrictStr = Field(description="注文パスワード", alias="Password")
    __properties: ClassVar[List[str]] = ["OrderId", "Password"]
