...
class AuthApi:
    ...
    def token_post(
        ...
        _param = self._token_post_serialize(
    ...
    @validate_call
    def token_post_without_preload_content(
        self,
        request_token: RequestToken,
        _request_timeout: Union[
            None,
